...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunction = function calcFunction() {
    ...
    if (sizeBlock.value == '' || materialBlock.value == '') {
      resultBlock.textContent = 'Для расчета стоимости необходимо выбрать размер и материал картины';
...
var drop = function drop() {
  ...
  function unhighLight(item) {
    ...
    } // item.closest('.file_upload').style.backgroundColor = bgc;
...
var filter = function filter() {
  ...
  var btnClicker = function btnClicker(menuItems, wrapperItems) {
    menuItems.forEach(function (item) {
      var str = '.' + item.classList[0];

      if (str === '.grandmother' || str === '.granddad') {
        item.addEventListener('click', function () {
          typeFilter();
        });
      } else {
        item.addEventListener('click', function () {
          typeFilter(wrapperItems.querySelectorAll(str));
        });
      }
    });
...
var scrolling = function scrolling(upSelector) {
  ...
  }); // скроллинг через request animation frame
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);
 // 1 - селектор отображающий слайды которые мы хотим переключать
// 2 - аргумент отвечающий за направление движения слайдера принимает строку
// 3 - 4 - селекторы кнопок управления слайдером
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("\u041E\u0448\u0438\u0431\u043A\u0430 \u0437\u0430\u043F\u0440\u043E\u0441\u0430 ".concat(url, ", status: ").concat(res.status));
